# Template for an Odoo 15 Project
...
```shell
git submodule add --name enterprise -b 15.0 https://github.com/ursais/enterprise.git \
  odoo/src/enterprise
```
...
```shell
git submodule add --name repo -b 15.0 https://github.com/ursais/repo.git \
